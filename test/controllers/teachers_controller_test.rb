...
class TeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teacher" do
    assert_difference('Teacher.count') do
      post teachers_url, params: { teacher: { first_name: @teacher.first_name, last_name: @teacher.last_name } }
    end
  ...
  test "should update teacher" do
    patch teacher_url(@teacher), params: { teacher: { first_name: @teacher.first_name, last_name: @teacher.last_name } }
