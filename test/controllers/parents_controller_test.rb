...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { address: @parent.address, city: @parent.city, first_name: @parent.first_name, last_name: @parent.last_name } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { address: @parent.address, city: @parent.city, first_name: @parent.first_name, last_name: @parent.last_name } }
